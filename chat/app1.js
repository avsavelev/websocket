...
const {productsBySubcategory, productsByQuery, productList, productById,
...
app.use(require('koa-static')(path.join(__dirname, 'public1')));
...
const index = fs.readFileSync(path.join(__dirname, 'public1/index.html'));
app.use(async (ctx) => {
